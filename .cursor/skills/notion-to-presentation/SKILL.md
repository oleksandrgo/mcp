...
2. Опціонально: додати посилання на презентацію в Notion → сторінка «Відео» лекції.

## Приклади

- Загальна структура деки: [`examples.md`](examples.md)
- **HTML-діаграми (обовʼязково для «Як це працює»):** [`diagram-examples.md`](diagram-examples.md)
...
- [ ] Останній слайд: «Підсумки» (текстом)
